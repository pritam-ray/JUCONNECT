-- Fix admin functions to handle edge cases and improve error handling

-- Improved remove_group_member function with better validation
...
-- Improved delete_group function with better validation
